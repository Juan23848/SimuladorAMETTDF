...
st.image('b34f112f-3441-4b8a-8ce4-3c3a78505a3a.png', width=120)
st.markdown("<h1 style='text-align: center; color: #b00000;'>🧮 Simulador Comparativo Salarial</h1><h3 style='text-align: center;'>Abril vs Mayo 2025 – AMET Tierra del Fuego</h3>", unsafe_allow_html=True)
st.markdown('---')
