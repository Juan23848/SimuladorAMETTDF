...
st.markdown("<div style='text-align: center'><img src='Amet Logo 1 (1).png' width='120'></div>", unsafe_allow_html=True)
st.markdown(""", unsafe_allow_html=True)
<h1 style='text-align: center; color: #0046be;'> Simulador Comparativo Salarial</h1>
<h3 style='text-align: center; color: #444;'>Abril vs Mayo 2025 - AMET Tierra del Fuego</h3>
...
if st.button("Calcular Comparación"):
    ...
    st.markdown("<div style='text-align:center;'><img src='501892306_18047675123611527_6059052974859941307_n.jpeg' width='140'></div>", unsafe_allow_html=True)
    st.markdown("<div style='text-align:center; font-size:14px; color:#888;'>Powered by @juanernestoamettdf</div>", unsafe_allow_html=True)
    st.markdown(f"<div style='text-align:center; font-size:26px; font-weight:bold; color:#000;'>Tu diferencia con el mes anterior es <span style='color:#0046be;'>${diferencia:,.2f}</span></div>", unsafe_allow_html=True)
    st.markdown("<div style='text-align:center; font-size:22px; color:#b00000;'><em>Seguimos muy lejos de salir de la pobreza.</em></div>", unsafe_allow_html=True)
    st.markdown("<br><div style='text-align:center;'><img src='4dbca68c-2246-4f86-8920-6af5e26248af.png' width='140'></div>", unsafe_allow_html=True)
    st.markdown("<div style='text-align:center; font-size:13px; color:#666;'>Powered by @juanernestoamettdf</div>", unsafe_allow_html=True)